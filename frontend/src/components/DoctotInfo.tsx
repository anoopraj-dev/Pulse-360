...
const DoctorInfo: FC<DoctorInfoProps> = ({ data }) => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
                <div className="border border-[#B0C4F2] rounded-sm p-4 bg-white shadow-md  w-[500px]">
                    <div className="flex gap-5 items-center">
                        <Icon icon="mdi-face-male-shimmer" className="w-16 h-16 text-[#0096C7]"></Icon>
            ...
            <div className="flex flex-col gap-15">
                <div>
                    <div className="border border-[#B0C4F2] rounded-sm p-4 bg-white shadow-md  w-[500px]">
                        <div className="flex gap-5 items-center">
                        <Icon icon="mdi-account-graduation" className="w-16 h-16 text-[#0096C7]"></Icon>
                        <h3 className="text-center font-semibold text-2xl">Proffessional Dashboard</h3>
                    </div>
                ...
                <div>
                    <div className="border border-[#B0C4F2] rounded-sm p-4 bg-white shadow-md  w-[500px]">
                        <div className="flex gap-5 items-center">
                            <Icon icon="mdi:account" className="w-16 h-16 text-[#0096C7]"></Icon>
